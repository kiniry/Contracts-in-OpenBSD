...
WHY=WHYLIB=$(WHYLIB) $(WHYEXEC) --no-arrays  -split-user-conj -explain -locs 4.loc

GWHY=WHYLIB=$(WHYLIB) $(GWHYEXEC) --no-arrays  -split-user-conj -explain -locs 4.loc
...
coq/4_why.v: why/4.why
	@echo 'why -coq-v8 [...] why/4.why' &&$(WHY) -coq-v8 -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition" $(JESSIELIBFILES) why/4.why

coq-goals: goals coq/4_ctx_why.vo
	for f in why/4_po*.why; do make -f 4.makefile coq/`basename $$f .why`_why.v ; done

coq/4_ctx_why.v: why/4_ctx.why
	@echo 'why -coq-v8 [...] why/4_ctx.why' &&$(WHY) -no-prelude -coq-v8 -dir coq -coq-preamble "Require Export jessie_why." -coq-tactic "intuition" why/4_ctx.why

coq/%_why.v: why/%.why
	@echo 'why -coq-v8 [...] why/$*.why' &&$(WHY) -no-prelude -coq-v8 -dir coq -coq-preamble "Require Export 4_ctx_why." -coq-tactic "intuition" why/4_ctx.why why/$*.why
...
depend: coq/4_why.v
	-$(COQDEP) -I coq coq/4*_why.v > 4.depend
